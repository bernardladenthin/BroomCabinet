...
function strstr_bench( $method, $needle = 'abcd' ) {
    ...
    bench();
    $caption = $method(
        "x2345678901234567890123456789012345678901234567890123456789012341234567890123456789012345678901234567890123456789012345678901234",
        $needle, $r);
    $d = bench();
    $sum = $d;
    echo '<tr><td><code>' . $caption . '</code></td>';
    ...
    bench();
    $method(
        "x2345678901234567890123456789012345678901234567890123456789012abcd34567890123456789012345678901234567890123456789012345678901234",
        $needle, $r);
    $d = bench();
    $sum += $d;
    ms( $d );
    ...
    bench();
    $method(
        "x234567890123456789012345678901234567890123456789012345678901234123456789012345678901234567890123456789012345678901234567890abcd",
        $needle, $r);
    $d = bench();
    $sum += $d;
    ms( $d );
...
created in September 2008, updated in February 2016<br />
