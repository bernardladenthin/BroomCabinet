package net.ladenthin.jscreenstreamer.client;
...
import net.ladenthin.jscreenstreamer.*;
import net.ladenthin.jscreenstreamer.byteprotocol.Message;
import net.ladenthin.jscreenstreamer.socket.Common;
import net.ladenthin.jscreenstreamer.socket.SecureClientRequestCycleSocket;
import net.ladenthin.jscreenstreamer.socket.ServerRequest;
import net.ladenthin.jscreenstreamer.socket.ServerResponse;
